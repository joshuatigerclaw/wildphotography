#!/usr/bin/env python3
"""
WildPhotography Batch 213
Scan 5 remaining galleries with unprocessed folders from Costa-Rica-Gallery:
Waterfalls-in-Costa-Rica, Tamarindo-Guanacaste-Costa-Rica, Rural-Costa-Rica,
Rivers, Tarcoles-
Galleries: waterfalls-in-costa-rica (100), tamarindo-guanacaste-costa-rica (94),
           rural-costa-rica (86), rivers (13), tarcoles (97)
...
GALLERY_MAP = {
    "Waterfalls-in-Costa-Rica":             (100, "waterfalls-in-costa-rica"),
    "Tamarindo-Guanacaste-Costa-Rica":      (94,  "tamarindo-guanacaste-costa-rica"),
    "Rural-Costa-Rica":                     (86,  "rural-costa-rica"),
    "Rivers":                               (13,  "rivers"),
    "Tarcoles-":                            (97,  "tarcoles"),
}
...
temp_dir = "/tmp/wildphoto_batch213"
...
print("=== WildPhotography Batch 213 ===")
...
for folder_name, (gallery_id, slug) in GALLERY_MAP.items():
    ...
    # Collect all valid image files (skip macOS ._ metadata files and .mp4 videos)
    all_images = []
