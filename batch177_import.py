#!/usr/bin/env python3
"""
WildPhotography Batch 177
Scan 2 galleries with unprocessed folders from Costa-Rica-Gallery:
Golfo-de-Nicoya, Playa-Real-Roble-Guanacaste-Costa-Rica
Galleries: Golfo-de-Nicoya (39), Playa-Real-Roble (72)
Source: /Volumes/ADATA SC740/Smugmug Backup/Galleries/Costa-Rica-Gallery
Note: Scope reduced to 2 folders x 15 photos max to avoid SIGKILL timeout.
      Filters out ._ macOS metadata files. Remaining folders deferred to batch178.
"""
...
GALLERY_MAP = {
    "Golfo-de-Nicoya":                             (39, "golfo-de-nicoya"),
    "Playa-Real-Roble-Guanacaste-Costa-Rica":      (72, "playa-real-roble-guanacaste-costa-rica"),
}
...
temp_dir = "/tmp/wildphoto_batch177"
...
print("=== WildPhotography Batch 177 ===")
