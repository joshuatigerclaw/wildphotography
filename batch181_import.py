#!/usr/bin/env python3
"""
WildPhotography Batch 181
Scan 5 galleries with unprocessed folders from Costa-Rica-Gallery:
Boats-in-Costa-Rica, Cartago, Costa-Rica, Costa-Rica-Buildings, Crocodiles
Galleries: Boats-in-Costa-Rica (21), Cartago (23), Costa-Rica (25), Costa-Rica-Buildings (26), Crocodiles (30)
...
GALLERY_MAP = {
    "Boats-in-Costa-Rica":        (21, "boats-in-costa-rica"),
    "Cartago":                    (23, "cartago"),
...
temp_dir = "/tmp/wildphoto_batch181"
...
print("=== WildPhotography Batch 181 ===")
