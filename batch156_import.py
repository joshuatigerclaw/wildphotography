#!/usr/bin/env python3
"""
WildPhotography Batch 156 (re-run with correct galleries)
Scan 5 galleries, import only confirmed new files.
Galleries: Dominical-and-Uvita(31), Flora-Fauna(34), Food(37),
           Guanacaste-Costa-Rica-Travel-and-Tourism(40), Heredia-Costa-Rica(41)
"""
...
temp_dir = "/tmp/wildphoto_batch156"
...
print("=== WildPhotography Batch 156 ===")
...
report_path = '/Users/joshuatenbrink/wildphotography_cloudflare_src/inventory/batch156_import_report.json'
