#!/usr/bin/env python3
"""
WildPhotography Batch 180
Scan 5 galleries with unprocessed folders from Costa-Rica-Gallery:
Bajos-del-Toro-Costa-Rica, Beaches, Best-of-Costa-Rica, Birds, Birds-Macaws-Lapas
Galleries: Bajos-del-Toro-Costa-Rica (17), Beaches (18), Best-of-Costa-Rica (19), Birds (5), Birds-Macaws-Lapas (20)
...
GALLERY_MAP = {
    "Bajos-del-Toro-Costa-Rica":  (17, "bajos-del-toro-costa-rica"),
    "Beaches":                    (18, "beaches"),
    "Best-of-Costa-Rica":         (19, "best-of-costa-rica"),
    "Birds":                      (5,  "birds"),
    "Birds-Macaws-Lapas":         (20, "birds-macaws-lapas"),
}
...
temp_dir = "/tmp/wildphoto_batch180"
...
print("=== WildPhotography Batch 180 ===")
