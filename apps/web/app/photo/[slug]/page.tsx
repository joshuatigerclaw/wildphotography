      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <div className="mb-6">
            ...
            <div className="flex flex-wrap gap-2">
              {photo.keywords.map((keyword: string) => (
                <span key={keyword} className="px-3 py-1 bg-gray-100 rounded-full text-sm">{keyword}</span>
              ))}
            </div>
          </div>
          <div className="mb-6">
          ...
          <div className="border-t pt-6">
            ...
            <button className="w-full py-3 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition font-semibold">Buy Download</button>
          </div>
        </div>
      </div>
    </div>
