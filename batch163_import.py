#!/usr/bin/env python3
"""
WildPhotography Batch 163
Scan 5 galleries, import only confirmed new files.
Galleries: Birds(5), Butterflies(22), Crocodiles(30),
           Flamingo-Beach(142), Flora-Fauna(34)
"""
...
GALLERY_MAP = {
    ...
    "Costa-Rica-Gallery/Flamingo-Beach":               (142, "costa-rica-gallery-flamingo-beach"),
...
temp_dir = "/tmp/wildphoto_batch163"
...
print("=== WildPhotography Batch 163 ===")
