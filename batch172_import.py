#!/usr/bin/env python3
"""
WildPhotography Batch 172
Scan folders: alajuela, china, china-shanghai
Galleries: alajuela (15, active), china (111, active), china-shanghai (112, active)
...
GALLERY_MAP = {
    ...
    "china":         (111, "asia-china"),
    "china-shanghai":(112, "asia-china-shanghai"),
}
...
temp_dir = "/tmp/wildphoto_batch172"
...
print("=== WildPhotography Batch 172 ===")
