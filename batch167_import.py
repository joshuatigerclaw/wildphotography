#!/usr/bin/env python3
"""
WildPhotography Batch 167
Regional galleries: Asia/China, Asia/China-Shanghai, Europe/France, South-America/Argentina.
All have active Neon galleries; Costa-Rica-Gallery is fully imported.
Note: Only 4 folders this batch (Costa-Rica-Gallery exhausted of active unmapped folders).
"""
...
GALLERY_MAP = {
    "Asia/China": (111, "asia-china"),
    "Asia/China-Shanghai":              (112, "asia-china-shanghai"),
...
temp_dir = "/tmp/wildphoto_batch167"
...
print("=== WildPhotography Batch 167 ===")
