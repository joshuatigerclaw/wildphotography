#!/usr/bin/env python3
"""
WildPhotography Batch 170
Single new file found: _uploaded_mirror/originals/arenal-volcano/dji-0423-26e16cd98c83.jpg
Gallery: Arenal-Volcano (gallery_id=16, active).
Source: /Volumes/ADATA SC740/Smugmug Backup/_uploaded_mirror/originals/arenal-volcano
Full scan confirms all other folders on ADATA SC740 are fully imported (duplicates only).
"""
...
GALLERY_MAP = {
    "arenal-volcano": (16, "arenal-volcano"),
}
...
temp_dir = "/tmp/wildphoto_batch170"
...
print("=== WildPhotography Batch 170 ===")
