#!/usr/bin/env python3
"""
WildPhotography Batch 176
Scan 5 galleries with unprocessed folders from Costa-Rica-Gallery:
Birds, Volcan-Irazu, Sunrise-Sunset, Flamingo-Beach, Playa-Hermosa-Guanacaste
Galleries: birds (5), volcan-irazu (14), sunrise-sunset (93), flamingo-beach (33), playa-hermosa-guanacaste (70)
...
GALLERY_MAP = {
    "Birds":                          (5,  "birds"),
    "Volcan-Irazu":                   (14, "volcan-irazu"),
    "Sunrise-Sunset":                 (93, "sunrise-sunset"),
    "Flamingo-Beach":                 (33, "flamingo-beach"),
    "Playa-Hermosa-Guanacaste":      (70, "playa-hermosa-guanacaste"),
}
...
temp_dir = "/tmp/wildphoto_batch176"
...
print("=== WildPhotography Batch 176 ===")
