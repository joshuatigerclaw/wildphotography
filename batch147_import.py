...
#5 galleries with confirmed Neon matches
GALLERY_MAP = {
...
print("=== WildPhotography Batch 147 ===")
...
temp_dir = "/tmp/wildphoto_batch147"
...
for folder_key, (gallery_id, gallery_slug) in GALLERY_MAP.items():
    ...
    # Validate gallery exists in Neon
