#!/usr/bin/env python3
"""
WildPhotography Batch 155
Scan5 galleries, import only confirmed new files.
Galleries: Cartago(23), Crocodiles(30), Jaco-Beach(48),
           Limon-Puerto-Viejo(57), Monkeys(59)
"""
...
temp_dir = "/tmp/wildphoto_batch155"
...
print("=== WildPhotography Batch 155 ===")
...
report_path = os.path.join(os.path.dirname(__file__), 'inventory', 'batch155_import_report.json')
