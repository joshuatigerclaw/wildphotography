#!/usr/bin/env python3
"""
WildPhotography Batch 175
Scan folders from Galleries/Costa-Rica-Gallery: Cartago, Costa-Rica, Costa-Rica-Buildings, Costa-Rica-Travel-Tourism, Crocodiles
Galleries: cartago (23), costa-rica (25), costa-rica-buildings (26), costa-rica-travel-tourism (27), crocodiles (30)
...
# Folder names match actual Costa-Rica-Gallery subfolder names
# Gallery IDs from Neon galleries table
GALLERY_MAP = {
    "Cartago":                              (23, "cartago"),
    "Costa-Rica":                            (25, "costa-rica"),
    "Costa-Rica-Buildings":                  (26, "costa-rica-buildings"),
    "Costa-Rica-Travel-Tourism":             (27, "costa-rica-travel-tourism"),
    "Crocodiles":                            (30, "crocodiles"),
}
...
temp_dir = "/tmp/wildphoto_batch175"
...
print("=== WildPhotography Batch 175 ===")
...
print(f"Processing {stats['folders_processed']} folders, max 100 photos per folder...")
print()
...
for folder_name, (gallery_id, slug) in GALLERY_MAP.items():
    ...
    # Limit to 100 photos per folder
    all_images = all_images[:100]
    
    photos_this_folder = 0
    for img_path in all_images:
        if photos_this_folder >= 100:
            break
    ...
    print(f"  Imported {photos_this_folder} new photos from {folder_name}")
    print()
