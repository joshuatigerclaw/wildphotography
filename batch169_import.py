#!/usr/bin/env python3
"""
WildPhotography Batch 169
Gallery: South-America/Peru (gallery_id=120, inactive but existing in Neon).
Peru folder has ~282 files on disk; DB shows 866 already imported — expecting 0 new.
Also process: South-America/Colombia-Cartagena-Islas-Baru (id=118, inactive) and
South-America/Panama- (id=119, inactive) — both confirmed inactive, skip explicitly.
"""
...
temp_dir = "/tmp/wildphoto_batch169"
...
print("=== WildPhotography Batch 169 ===")
