#!/usr/bin/env python3
"""
Build import batch - May 20 evening batch (third pass)
5 high-value remaining folders with verified existing gallery matches.
"""
import os
import json
import hashlib
...
targets = [
    ...
    {'folder': 'Costa-Rica-Gallery/Landmarks',                    'gallery_id': 53,  'gallery_slug': 'landmarks'},
]
