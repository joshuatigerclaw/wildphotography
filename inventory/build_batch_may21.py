#!/usr/bin/env python3
"""
Build import batch - May 21 batch
5 folders with disk photos but low/neon counts (gap opportunity)
"""
import os
import json
import hashlib
...
targets = [
    ...
    {'folder': 'Costa-Rica-Gallery/Santa-Teresa-Malpais',                       'gallery_id': 91,  'gallery_slug': 'santa-teresa-malpais'},
    {'folder': 'Costa-Rica-Gallery/Playas-del-Coco',                            'gallery_id': 73,  'gallery_slug': 'playas-del-coco'},
    {'folder': 'Costa-Rica-Gallery/La-Sabana-Estadio-Nacional-Costa-Rica-San-Jose', 'gallery_id': 50, 'gallery_slug': 'la-sabana-estadio-nacional-costa-rica-san-jose'},
    {'folder': 'Costa-Rica-Gallery/Golfo-de-Nicoya',                            'gallery_id': 39,  'gallery_slug': 'golfo-de-nicoya'},
]
...
for target in targets:
    ...
    if not os.path.isdir(folder_path):
        print(f'SKIP: {folder} not found at {folder_path}')
        continue
    ...
    print(f'\nFolder: {folder} ({len(image_files)} files, gallery_id={gallery_id})')
