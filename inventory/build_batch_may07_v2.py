#!/usr/bin/env python3
"""
Build import batch from 5 different Costa-Rica-Gallery folders - May 7 v2.
...
# 5 DIFFERENT folders with existing Neon galleries
targets = [
    {'folder': 'Costa-Rica-Gallery/Food-',                  'gallery_id': 37,  'gallery_slug': 'food'},
    ...
    {'folder': 'Costa-Rica-Gallery/Rincon-de-La-Vieja',      'gallery_id': 149, 'gallery_slug': 'rincon-de-la-vieja'},
]
