#!/usr/bin/env python3
"""
Discover truly new files from Costa-Rica-Gallery that are NOT in DB.
Scans the 5 target folders and cross-references against Neon DB.
"""
import os
import json
import hashlib
...
if items:
    ...
    print('No new items found - all files are duplicates.')
