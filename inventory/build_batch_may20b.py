#!/usr/bin/env python3
"""
Build import batch - May 20 evening batch (second pass)
5 folders with confirmed existing gallery matches.
"""
import os
import json
import hashlib
...
targets = [
    {'folder': 'Costa-Rica-Gallery/Beaches',                   'gallery_id': 110, 'gallery_slug': 'costa-rica-gallery-beaches'},
