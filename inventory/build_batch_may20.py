#!/usr/bin/env python3
"""
Build import batch - May 20 evening batch
5 folders with existing gallery matches in Neon.
"""
import os
import json
import hashlib
...
targets = [
    ...
    {'folder': 'Costa-Rica-Gallery/Dominical-and-Uvita',          'gallery_id': 31, 'gallery_slug': 'dominical-and-uvita'},
